...
@{
    ...
    FunctionsToExport = 'Connect-VSANDataProtection', 'Get-VSANDataProtectionVersion', 'Get-VSANDataProtectionGroup', 'New-VSANDataProtectionGroup', 'Remove-VSANDataProtectionGroup'
